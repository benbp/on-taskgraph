...
function taskSchedulerFactory(
    ...
    function TaskScheduler(options) {
        ...
        this.checkGraphFinishedInterval = 1000 * 30;
    ...
    TaskScheduler.prototype.getConcurrencyMaximums = function(concurrentOptions) {
        ...
        var _options = _.defaults(concurrentOptions || {}, {
            ...
            checkTaskStateHandledByGraph: 50,
            findReadyTasks: 50,
            handleFailGraphEvent: 50,
            updateTaskDependencies: 50,
            handleScheduleTaskEvent: 50,
    ...
    TaskScheduler.prototype.handleGraphFinishedEvent = function(data) {
        ...
        return Rx.Observable.just(data)
        .flatMap(function(data) {
            //TODO clean up to only accept w/ graphId \remove flatmap
            if (!data.graphId) {
                logger.debug('what is this junk', {data:data});
