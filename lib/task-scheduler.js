...
function taskSchedulerFactory(
        ...
        .subscribe(
            function(graphId) {
                evaluateGraphStream.onNext.bind(evaluateGraphStream,
                    { graphId: graphId, evaluatedOnly: false });
            },
    ...
    // TODO: REMOVE DEBUG
    TaskScheduler.prototype.DEBUG = function() {
        return false;
        // return true;
    };
    ...
    TaskScheduler.prototype.createStartTaskGraphSubscription =
        ...
        .subscribe(
            function(graphId) {
                evaluateGraphStream.onNext({ graphId: graphId, evaluatedOnly: false });
            },
    ...
    TaskScheduler.prototype.findUnevaluatedTasks = function() {
        ...
        .tap(function(tasks) {
            if (tasks && tasks.length) {
                logger.silly('Poller is triggering unevaluated tasks to be evaluated', {
