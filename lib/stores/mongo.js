...
function mongoStoreFactory(waterline, Promise, Constants, Errors, assert, _) {
    ...
    exports.heartbeatTasksForRunner = function(leaseId) {
        var query = {
            ...
            reachable: true,
            $or: [
                { evaluated: true, state: Constants.TaskStates.Pending },
                { evaluated: false, state: { $in: Constants.FinishedTaskStates }}
            ]
        };
        var update = {
            $set: {
    ...
    exports.heartbeatTasksForScheduler = function(leaseId) {
        var query = {
    ...
    exports.expireTaskRunnerLease = function(objId) {
        assert.string(objId);
    ...
    exports.deleteAllFromCompletedGraph = function(graphId) {
        assert.string(graphId);
