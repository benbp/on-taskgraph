...
di.annotate(runnerFactory, new di.Inject(
        ...
        'TaskGraph.CompletedTaskDeletionPoller',
        'Promise'
    )
);
    ...
    Runner.prototype.start = function(options) {
        ...
        .then(function() {
            if (self.taskScheduler) {
                self.taskDeletionPoller =  TaskDeletionPoller.create(self.taskScheduler.domain);
            //    return self.taskDeletionPoller.start();
            }
        });
    ...
    */
    ...
    Runner.prototype.stop = function() {
        ...
        .then(function() {
            ...
            if (self.taskDeletionPoller) {
                self.taskDeletionPoller.stop();
            }
        })
        .then(function() {
            return core.stop();
