...
function taskGraphFactory(
    ...
    TaskGraph.create = function (definition, options, context) {
        ...
        // that we don't modify the source object just in case.
        definition.options = _.merge(definition.options || {}, options || {});
        return new TaskGraph(definition, context).validate()._populateTaskData();
    };
